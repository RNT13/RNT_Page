  ...
  resources: {
    en: {
      translation: {
        ...
        payment: 'Payment',
        paymentDisclaimer:
          'When opting for this payment method, it is important to remember that confirmation can take up to 3 business days, due to the deadlines set by financial institutions. Therefore, the release of the activation code for the purchased game will only occur after approval of the bank slip payment.',
